...
const bannerSlides = [
  {
    id: 1,
    image: "/images/hero-sale-50-off.png",
  ...
  {
    id: 2,
    image: "/images/hero-most-wanted-footwear.jpeg",
    alt: "Most Wanted Footwear",
    ctaText: "Shop Now",
    ctaLink: "#",
  },
  {
    id: 3,
    image: "/images/hero-forever-forward.jpeg",
    alt: "Forever Forward",
    ctaText: "Shop Now",
    ctaLink: "#",
  },
...
export default function HeroBanner() {
  ...
  return (
    <section className="relative w-full overflow-hidden" onMouseEnter={pauseAutoPlay} onMouseLeave={resumeAutoPlay}>
      {/* Slides */}
